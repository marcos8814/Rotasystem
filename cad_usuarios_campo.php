...
<div class="content">
  ...
  <div class="row presentation">
    ...
    <div class="col-lg-8 col-md-6 titles">
      ...
      <h1>Altera campo do Usuario no sistema</h1>
            ...
            <div class="panel-body">
              <form class="form-horizontal" method="POST">
                ...
                <div class="form-group">
                  <label for="input001" class="col-sm-2 control-label form-label">Nome Completo</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input001" name="nome">
                    <span id="helpBlock" class="help-block">Ex. José de Oliveira Martins</span>
                  </div>
                </div>

                <div class="form-group">
                  <label for="input001" class="col-sm-2 control-label form-label">E-mail</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input001" name="email">
                    <span id="helpBlock" class="help-block">Ex. jose@dominio.com.br</span>
                  </div>
                </div>

                <div class="form-group">
                  <label for="input001" class="col-sm-2 control-label form-label">Contato / Fone</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input001" name="fone">
                    <span id="helpBlock" class="help-block">Ex. (XX) XXXX-XXXX</span>
                  </div>
                </div>

                 <div class="form-group">
                  <label for="input001" class="col-sm-2 control-label form-label">CPF</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input001" name="cpf">
                    <span id="helpBlock" class="help-block">Ex. XXXXXXXXX-XX</span>
                  </div>
                </div>


                <div class="form-group">
                  <label for="input001" class="col-sm-2 control-label form-label">Login</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input001" name="login">
                    <span id="helpBlock" class="help-block">Ex. Jose</span>
                  </div>
                </div>

                <div class="form-group">
                  <label for="input001" class="col-sm-2 control-label form-label">Senha</label>
                  <div class="col-sm-10">
                    <input type="password" class="form-control" id="input001" name="senha">
                    <span id="helpBlock" class="help-block">Ex. (XX) XXXX-XXXX</span>
                  </div>
                </div>

                <div class="form-group">
                  <label for="input001" class="col-sm-2 control-label form-label">nivel</label>
                  <div class="col-sm-10">
...
<?php
          ...
          if (isset($_POST['salvar']))
          {
            ...
            // inserindo os dados no banco da tabela rotas
              $insertusuario=$con->prepare("INSERT INTO usuario 
                (usu_nome, usu_email, usu_fone, usu_login, usu_senha, usu_nivel,usu_cpf) 
                VALUES 
                (:usu_nome, :usu_email, :usu_fone, :usu_login, :usu_senha, :usu_nivel, :usu_cpf)");
              
              $insertusuario->bindValue(":usu_nome", $nome);
              $insertusuario->bindValue(":usu_email", $email);
              $insertusuario->bindValue(":usu_fone", $fone);
              $insertusuario->bindValue(":usu_login", $login);
              $insertusuario->bindValue(":usu_senha", $senha);
              $insertusuario->bindValue(":usu_nivel", $nivel);
              $insertusuario->bindValue(":usu_cpf", $cpf);
