                  ...
                  <?php
                    ...
                    $selecionausuario->execute();
                      while ($linha=$selecionausuario->fetch(PDO::FETCH_ASSOC)) 
                      {
                            ...
                            if ($linha["vei_status"]=='Em rota') {
                              echo '
                              <tr>

                                <td><font color="red">'.$linha["vei_id"].'</font></td>
                                 <td><font color="red">'.$linha["vei_modelo"].'</font></td>
                                 <td><font color="red">'.$linha["vei_marca"].'</font></td>
                                 <td><font color="red">'.$linha["vei_placa"].'</font></td>
                                 <td><font color="red">'.$linha["vei_ano"].'</font></td>
                                 <td><font color="red">'.$linha["vei_lotacao"].'</font></td>
                                 <td><font color="red">'.$linha["vei_datavistoria"].'</font></td>
                                 <td><font color="red">'.$linha["vei_etiqueta"].'</font></td>
                                 <td><font color="red">'.$linha["vei_status"].'</font></td>
                            ...
                            ';
                              ...
                              echo '
                              <tr>
                                <td><font color="green">'.$linha["vei_id"].'</font></td>
                                 <td><font color="green">'.$linha["vei_modelo"].'</font></td>
                                 <td><font color="green">'.$linha["vei_marca"].'</font></td>
                                 <td><font color="green">'.$linha["vei_placa"].'</font></td>
                                 <td><font color="green">'.$linha["vei_ano"].'</font></td>
                                 <td><font color="green">'.$linha["vei_lotacao"].'</font></td>
                                 <td><font color="green">'.$linha["vei_datavistoria"].'</font></td>
                                 <td><font color="green">'.$linha["vei_etiqueta"].'</font></td>
                                 <td><font color="green">'.$linha["vei_status"].'</font></td>
                              </tr>
                            ';
                            }
