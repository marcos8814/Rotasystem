...
<?php
                    ...
                    if (isset($_POST['salvar']))
          {
            ...
            if(!empty($_POST["id"])&& !empty($_POST["nome"])&& !empty($_POST["email"]));
                    ...
                    $selecionausuario=$con->prepare("UPDATE usuario SET nome= :usu_nome, email= usu_email WHERE id=:usu_id");
                    $selecionausuario->bindValue(":usu_nome",$nome);
                    $selecionausuario->bindValue(":usu_email",$email);
                    $selecionausuario->bindValue(":usu_id",$id);
