    ...
    <div class="col-lg-8 col-md-6 titles">
      <span class="icon color10-bg"><i class="fa fa-table"></i></span>
        ...
        <?php
                    ...
                    $usuid = addslashes(trim($_GET["id"]));
                    $deletausuario=$con->prepare("DELETE FROM usuario WHERE usu_id=?");
                    $deletausuario->bindValue(1,$usuid);
                    $deletausuario->execute();

                    if($deletausuario->rowCount() > 0):
                      echo "<h1>Sucesso.!! Usuário excluido do sistema</h1>";
                     else:
                      echo "<h1>Erro.!! Usuário não existe no sistema</h1>";
                    endif;
      ...
      <h4>Aqui é possivel listar e pesquisar todos os usuários</h4>
    </div>
        ...
        <div class="panel-body table-responsive">
            ...
            <table id="example0" class="table display">
                ...
                <tbody>
                  ...
                  <?php
                    include('conexaopdo.php');
                    $selecionausuario=$con->prepare("SELECT * FROM usuario");
                            ...
                            echo '
                              <tr>
                                <td>'.$linha["usu_id"].'</td>
                                 ...
                                 <td>'.$linha["usu_fone"].'</td>
                                 <td>'.$linha["usu_login"].'</td>
                                 <td>'.$linha["usu_senha"].'</td>
                                 <td>'.$linha["usu_nivel"].'</td>
                                 <td><a href="deleta_usuarios.php?id='.$linha["usu_id"].'"><button type="submit" class="btn btn-default" >Excluir</button></a href</td>
                              </tr>
                            ';
                       }
