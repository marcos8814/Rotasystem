  ...
  <div class="row presentation">
    ...
    <div class="col-lg-8 col-md-6 titles">
      ...
      <h1><?php
                    ...
                    $motid = addslashes(trim($_GET["id"]));
                    $deletamotorista=$con->prepare("DELETE FROM motorista WHERE mot_id=?");
                    $deletamotorista->bindValue(1,$motid);
                    $deletamotorista->execute();

                    if($deletamotorista->rowCount() > 0):
                      echo "<h1>Campo Excluido!</h1>";
                     else:
                      echo "<h1>Erro.!! não existe no sistema</h1>";
                    endif;
                            ...
                            echo '
                              <tr>
                                <td>'.$linha["mot_id"].'</td>
                                 ...
                                 <td><a href="deleta_motoristas_confirma.php?id='.$linha["mot_id"].'"><button type="submit" class="btn btn-default" >DELETAR</button></a href></td>
                              </tr>
                            ';
                       }
