...
<div class="content">
  ...
  <div class="row presentation">
    ...
    <div class="col-lg-8 col-md-6 titles">
      ...
      <h1>Lista de Rotas do sistema</h1>
      <h4>Aqui é possivel listar e pesquisar todas as rotas</h4>
    </div>
                        ...
                        if ($linha["rot_status_rota"] =="Finalizada") 
                          {
                            echo '
                                <tr>
                                 ...
                                 <td><font color="red">'.$linha["rot_rfid"].'</font></td>
                        ...
                        else if ($linha["rot_status_rota"] =="Inativo") 
                        {
                            echo '
                              <tr>
                                 ...
                                 <td><font color="grey">'.$linha["rot_rfid"].'</font></td>
                            ...
                            echo '
                              <tr>
                                <td><font color="green">'.$linha["rot_id"].'</font></td>
                                 ...
                                 <td><font color="green">'.$linha["rot_rfid"].'</font></td>
