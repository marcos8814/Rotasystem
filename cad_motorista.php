...
<div class="content">
  ...
  <div class="row presentation">
    ...
    <div class="col-lg-8 col-md-6 titles">
      ...
      <h1>Cadastro de Motoristas do sistema</h1>
      <h4>Aqui é possivel cadastrar os Motoristas do sistema</h4>
    </div>
            ...
            <div class="panel-body">
              <form class="form-horizontal" method="POST">
                ...
                <div class="form-group">
                  <label for="input001" class="col-sm-2 control-label form-label">Nome</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input001" name="nome">
                    <span id="helpBlock" class="help-block">Ex. José </span>
                  
                  </div>
                </div>

                <div class="form-group">
                  <label for="input001" class="col-sm-2 control-label form-label">Categoria / Habilitação</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input001" name="cat">
                    <span id="helpBlock" class="help-block">Ex. D</span>
                  </div>
                </div>
...
<?php
          ...
          { 
            ...
            // inserindo os dados no banco da tabela rotas
              $insertobjeto=$con->prepare("INSERT INTO motorista 
                (mot_nome, mot_cat, mot_fone) 
                VALUES 
                (:mot_nome, :mot_cat, :mot_fone)");
              
              $insertobjeto->bindValue(":mot_nome", $nome);
              $insertobjeto->bindValue(":mot_cat", $cat);
              $insertobjeto->bindValue(":mot_fone", $fone);
